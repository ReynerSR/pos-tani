            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="promo_name"
                           ...
                           value="{{ old('promo_name',$promotion->promo_name) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="autocomplete-wrap">
                        ...
                        <input type="hidden" name="product_id" id="product_id" value="{{ old('product_id',$promotion->product_id) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="notes" class="form-control" rows="2">{{ old('notes',$promotion->notes) }}</textarea>
                </div>

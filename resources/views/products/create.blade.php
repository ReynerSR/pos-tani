...
<div class="page-hdr">
    <div class="page-hdr-left">
        <h1><i class="bi bi-plus-square me-2" style="color:var(--primary)"></i>Tambah Produk</h1>
...
<form method="POST" action="{{ route('products.store') }}">
    ...
    <div class="card">
        <div class="card-body row g-3">
            ...
            <div class="col-md-3"><label class="form-label">HPP Awal</label>
                <div class="input-group"><span class="input-group-text">Rp</span><input type="text" name="hpp" id="hpp" class="form-control rupiah-input" value="{{ old('hpp',0) }}" oninput="calcSelling()"></div>
                <div class="form-text">Set 0 jika HPP akan dihitung dari pembelian/restock pertama.</div>
            </div>
            ...
            @if(auth()->user()->role === 'pemilik')
            <div class="col-md-3"><label class="form-label">Stok Awal Toko</label><input type="number" name="stock" class="form-control" value="{{ old('stock',0) }}" min="0">
                <div class="form-text">Stok tambahan lokasi lain dimasukkan lewat Pembelian/Restock atau Stock Opname.</div>
            </div>
            @else
            <input type="hidden" name="stock" value="0">
            @endif
            <div class="col-md-3 d-flex align-items-end">
                <div class="form-check form-switch"><input type="hidden" name="is_active" value="0"><input class="form-check-input" type="checkbox" name="is_active" value="1" checked><label class="form-check-label">Produk aktif</label></div>
            </div>
            <div class="col-12">
                <div class="alert alert-info mb-0">Supplier tidak dipilih di Master Produk. Supplier digunakan saat modul Pembelian/Restock sesuai faktur supplier.</div>
            </div>
        </div>
        <div class="card-body border-top"><button class="btn btn-primary"><i class="bi bi-check-lg me-2"></i>Simpan Produk</button></div>
    </div>
</form>

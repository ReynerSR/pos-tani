...
<div class="card"><div class="card-body row g-3">
    ...
    <div class="col-md-3"><label class="form-label">HPP</label><div class="input-group"><span class="input-group-text">Rp</span><input type="text" name="hpp" id="hpp" class="form-control rupiah-input" value="{{ old('hpp',(int)$product->hpp) }}" required oninput="calcSelling()"></div><div class="form-text">HPP otomatis diperbarui oleh Pembelian/Restock.</div></div>
    ...
    <div class="col-md-3"><label class="form-label">Harga Jual *</label><div class="input-group"><span class="input-group-text">Rp</span><input type="text" name="selling_price" id="selling_price" class="form-control rupiah-input" value="{{ old('selling_price',(int)$product->selling_price) }}" required></div></div>
    @else

...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .bg-grad-teal {
            background: linear-gradient(135deg, #0d7a72, #17a589);
        }

        .bg-grad-orange {
            background: linear-gradient(135deg, #c87000, #f39c12);
        }

        .bg-grad-purple {
            background: linear-gradient(135deg, #5b2192, #8e44ad);
        }
